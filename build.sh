...
command -v nvidia-smi && install-ollama
...
curl -Lo /etc/yum.repos.d/_starship.repo https://copr.fedorainfracloud.org/coprs/atim/starship/repo/fedora-$(rpm -E %fedora)/atim-starship-fedora-$(rpm -E %fedora).repo
